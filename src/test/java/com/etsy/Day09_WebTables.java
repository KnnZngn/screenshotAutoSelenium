...
import com.etsy.utilities.TestBase;
girtimport org.junit.Test;
...
//    Task 4 : Print column 5 data in the table body
    ...
    public void printColumns(){
        ...
        for (WebElement each : column5){
            System.out.println(each.getText()); //w.getTex
        }
...
//    Task 5 : Write a method that accepts 2 parameters !! onemliiii
    public void printData(int rowNum, int colNum){  //tr yerine rowNum td yerine colNum ve method hazir

        driver.get("https://the-internet.herokuapp.com/tables"); //sadece bu sitede isler

                                //table[@id='table1']//tbody//tr[5]//td[5]  //tr yerine rowNum td terine colNum
                                //table[@id='table1']//tbody//tr[1]//td[2]
                                //table[@id='table1']//tbody//tr[2]//td[3]
        String xPath = "//table[@id='table1']//tbody//tr["+rowNum+"]//td["+colNum+"]"; //onemliiii
        WebElement targetElement = driver.findElement(By.xpath(xPath));
        System.out.println(targetElement.getText());
    }

    public void printData(int rowNum, int colNum, String tableID){ //tr yerine rowNum// td yerine colNum// ve table numarsi ve method hazir
        driver.get("https://the-internet.herokuapp.com/tables");
